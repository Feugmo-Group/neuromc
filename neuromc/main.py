#!/usr/bin/env python3
"""
neuromc: Monte Carlo Simulations with Machine-Learned Interatomic Potentials
...
def download_model_from_huggingface(
    ...
    # as documented: ~/.cache/neuromc/<repo>/<filename>
...
def _print_banner():
    """Print ASCII art banner for neuromc."""
    banner_lines = [
        "███    ███ ██      ██ ██████        ███    ███  ██████ ",
        "████  ████ ██      ██ ██   ██       ████  ████ ██      ",
        "██ ████ ██ ██      ██ ██████  █████ ██ ████ ██ ██      ",
...
def _detect_backend() -> str:
    ...
    raise ImportError(
        ...
        "  pip install neuromc[fairchem]\n"
        "  pip install neuromc[mace-torch]\n"
        "  pip install neuromc[orb-models]"
    )
...
def run_single_pressure(
    ...
    try:
        ...
        import torch
        from neuromc.src.gcmc import MLP_GCMC
        from neuromc.src.utilities import PREOS
...
def parse_arguments() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(
        description='neuromc: Run GCMC isotherm simulation for gas adsorption',
...
# CLI entry point is in neuromc.cli
