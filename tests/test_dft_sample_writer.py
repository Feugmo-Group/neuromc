"""Tests for neuromc.dft.sample_writer (HDF5 I/O)."""
import numpy as np
import pytest
import tempfile
...
from neuromc.dft.density_grid import DensityGrid1D
from neuromc.dft.external_field import random_fourier_field
...
class TestSampleWriter:
    ...
    def test_write_and_load(self, sample_data, tmp_path):
        from neuromc.dft.sample_writer import SampleWriter, load_sample
    ...
    def test_file_named_correctly(self, sample_data, tmp_path):
        from neuromc.dft.sample_writer import SampleWriter
    ...
    def test_missing_h5py_raises(self, monkeypatch):
        import neuromc.dft.sample_writer as sw
